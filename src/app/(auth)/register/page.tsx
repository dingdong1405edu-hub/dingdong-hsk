      ...
      <div className="animate-fade-up relative w-full max-w-md">
        ...
        <Card className="border-border/60 shadow-soft-lg">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-extrabold">Tạo tài khoản</CardTitle>
          ...
          <CardContent>
            <Button type="button" className="h-11 w-full text-[15px]" disabled={loading} onClick={handleGoogle}>
              ...
              {loading ? "Đang chuyển tới Google..." : "Đăng ký với Google"}
            </Button>

            <p className="mt-4 text-center text-xs leading-relaxed text-muted-foreground">
              Hệ thống chỉ hỗ trợ đăng nhập bằng tài khoản Google.
            </p>
