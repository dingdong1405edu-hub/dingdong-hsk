      ...
      <div className="relative w-full max-w-md">
        ...
        <Card className="border-border/60 shadow-soft-lg">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-extrabold">Chào mừng trở lại</CardTitle>
            <CardDescription>Đăng nhập để tiếp tục học tiếng Trung</CardDescription>
          </CardHeader>
          <CardContent>
            <Button type="button" className="h-11 w-full text-[15px]" disabled={loading} onClick={handleGoogle}>
            ...
            <p className="mt-4 text-center text-xs leading-relaxed text-muted-foreground">
              Hệ thống chỉ hỗ trợ đăng nhập bằng tài khoản Google. Lần đầu đăng nhập sẽ tự động tạo tài khoản
              cho bạn.
            </p>
          </CardContent>
        </Card>
